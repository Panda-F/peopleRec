...
def parse_args():
    ...
    parser.add_argument('--video', default="/home/fangzhou/视频/xiangsheng_cut.mp4", help='Video file')
    parser.add_argument('--config',
                        default="/home/fangzhou/Checkpoints/xiangsheng_0311_dino/dino-4scale_r50_8xb2-12e_coco.py",
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default="/home/fangzhou/Checkpoints/xiangsheng_0311_dino/epoch_12.pth",
                        help='Checkpoint file')
    parser.add_argument(
        '--device', default='cuda:0', help='Device used for inference')
    parser.add_argument(
        '--score-thr', type=float, default=0.7, help='Bbox score threshold')
    parser.add_argument('--out', default="/home/fangzhou/视频/dino_res.mp4", type=str, help='Output video file')
